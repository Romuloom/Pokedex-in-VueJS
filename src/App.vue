...
<div id="app">
  ...
  <div class="column is-half is-offset-one-quarter">
    <img src="./assets/dlf.pt-poliwrath-png-454758.png"/>
    <hr>
    <h4 class="is-size-4">1º Geração</h4>
    <input class="input is-rounded" type="text" name="" id="" placeholder="Buscar pokemon" v-model="busca">
